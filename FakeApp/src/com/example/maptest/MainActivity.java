...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize map view
        mitems.add(gmap.addMarker(new MarkerOptions().position(new LatLng(mylat,mylon)).title("Fake Signal")));
